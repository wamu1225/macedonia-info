...
export const TIMELINE: TimelineEntry[] = [
  { when: '前7世紀ごろ', title: 'アルゲアス朝の起こり', note: 'エーゲ海北岸にアルゲアス朝のマケドニア王国が興る。王家はギリシャ南部に起源を持つと称しました。', era: 'archaic', link: 'argead' },
  ...
  { when: '2020年', title: 'NATO加盟', note: '2020年3月、北大西洋条約機構（NATO）の加盟国となります。EU加盟への歩みも続く。', era: 'modern', link: 'modern' },
];
