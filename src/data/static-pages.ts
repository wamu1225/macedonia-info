...
export const ABOUT_CONTENT = `本サイト「${SITE_NAME}」は、古代マケドニア王国を中心に、その興亡と、「マケドニア」という名が現代までたどった道すじを、一望できるようにまとめたものです。トップでは古代から現代までを結ぶ年表を示し、各ページでアルゲアス朝、フィリッポス2世、アレクサンドロス大王、ディアドコイの争い、ヴェルギナとペラの考古学、中世から現代の北マケドニア共和国と国名問題までを扱う。
